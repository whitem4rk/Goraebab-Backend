...
public class StorageControllerTest {
  ...
  @MockBean private StorageServiceImpl storageService;
  ...
  void copyStorage() throws Exception {
    mockMvc
        .perform(post("/remote/storage/{storageId}/copy", 1L))
        .andExpect(status().isOk())
        .andDo(print());
  }
  ...
  void copyStorage_fail() throws Exception {
    ...
    mockMvc
        .perform(post("/remote/storage/{storageId}/copy", 111L))
  ...
  void disconnectStorage() throws Exception {
    mockMvc
        .perform(delete("/remote/storage/{storageId}", 1L))
        .andExpect(status().isOk())
        .andDo(print());
  }
}
