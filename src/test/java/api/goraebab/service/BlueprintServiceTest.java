...
public class BlueprintServiceTest {
  ...
  @Spy private BlueprintMapper blueprintMapper = Mappers.getMapper(BlueprintMapper.class);

  @InjectMocks private BlueprintServiceImpl blueprintService;
  ...
  void getBlueprint() {
    // given
    given(blueprintRepository.findByStorageIdAndId(anyLong(), anyLong()))
  ...
  void deleteBlueprint() {
    // given
    given(blueprintRepository.findByStorageIdAndId(anyLong(), anyLong()))
        .willReturn(Optional.ofNullable(blueprint));
