...
public class StorageController {
  ...
  @Operation(
      summary = "Load remote daemons info from database.",
      description =
          "This API fetches the info of remote storage daemons from the database "
  ...
  @Operation(
      summary = "Connect and save remote storage in database.",
      description =
          "Establishes a connection to a remote storage and saves the connection details "
  ...
  public ResponseEntity<Void> connectStorage(@RequestBody @Valid StorageReqDto storageReqDto) {
  ...
  @Operation(
      summary = "Copy remote storage blueprints into database",
      description =
          "Copies the blueprints of a remote storage into the local database "
  ...
  public ResponseEntity<Void> copyStorage(
      @PathVariable @Schema(description = "The unique identifier of the storage to be copied.")
          Long storageId) {
  ...
  @Operation(
      summary = "Delete remote storage in database",
      description =
          "Deletes the connection and stored info of a remote storage "
  ...
  public ResponseEntity<Void> disconnectStorage(
      @PathVariable @Schema(description = "The unique identifier of the storage to be deleted.")
          Long storageId) {
