...
public class DaemonController {
  ...
  @Operation(
      summary = "Connect and save remote daemon in database",
      description =
          "Establishes a connection to a remote daemon and saves its details in the database.")
  ...
  @Operation(
      summary = "Delete remote daemon in database",
      description =
          "Deletes the connection and stored information of a remote daemon from the database based on the provided daemon ID.")
  ...
  public ResponseEntity<Void> disconnectDaemon(
      @PathVariable
          @Schema(description = "The unique identifier of the Docker daemon to be deleted.")
          Long daemonId) {
