...
public class BlueprintController {
  ...
  @Operation(
      summary = "Retrieve the list of blueprints",
  ...
  public ResponseEntity<List<BlueprintsResDto>> getBlueprints(
  ...
  @Operation(
      summary = "Retrieve a single blueprint",
  ...
  @Operation(
      summary = "Save the blueprint to the local database",
      description =
          "Saves a new blueprint associated with the specified storage ID to the local database.")
  @PostMapping
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Success"),
  ...
  @Operation(
      summary = "Delete the blueprint",
      description =
          "Deletes the specified blueprint from the local database based on the blueprint ID.")
